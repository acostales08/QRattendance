    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-3">
                <h5 style="color: purple;"><b><?php date_default_timezone_set('Asia/Manila'); echo date("l") ." ". date('Y-m-d') ?></b></br></h5>
                <h5 style="color: purple;"><b><?php echo date("g:i A") ?></b></br></h5>
                </div>
                <div class="col-sm-6">
                      <form role="form" action="dash.php" method="POST">                 
                                      <div class="form-group col-md-12">
                                          <select name="class" id="" class="custom-select select2" onchange="this.form.submit()" required>
                                              ...
                                              inner join subjects s on s.id 
                                              where f.id = $faculty order by concat(co.course,' ',c.level,'-',c.section) asc");
